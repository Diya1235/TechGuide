  ...
  return (
    <div className="max-w-[750px] mx-auto bg-white shadow-lg p-10 font-[Arial] text-[#222] text-[14px] leading-[1.8]">
      ...
      <p className="text-sky-600 font-semibold mb-2 text-sm">
        <strong className="text-sky-600">{formData.senderTitle}</strong>
      </p>

      {/* Contact Bar */}
      <div className="flex flex-wrap items-center text-sky-600 text-xs mb-4 gap-4">
      ...
      {/* Cover Letter Title */}
      <p className="text-[15px] font-bold text-gray-900 mb-1 uppercase">Cover Letter</p>
