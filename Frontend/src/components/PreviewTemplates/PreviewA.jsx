...
const PreviewA = ({ formData }) => {
  ...
  return (
    <div className="p-8 bg-white rounded-lg shadow-lg max-w-4xl mx-auto border border-gray-200">
      ...
      {/* Profile Summary */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold border-b pb-1 mb-2 text-center uppercase">Profile Summary</h2>
        <p className="text-sm text-left">{formData?.summary || "N/A"}</p>
      </div>

      {/* Education */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold border-b pb-1 mb-2 text-center uppercase">Education</h2>
      ...
      {/* Work Experience */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold border-b pb-1 mb-2 text-center uppercase">Work Experience</h2>
      ...
      {/* Projects */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold border-b pb-1 mb-2 text-center uppercase">Projects</h2>
      ...
      {/* Certifications */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold border-b pb-1 mb-2 text-center uppercase">Certifications</h2>
      ...
      {/* Skills */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold border-b pb-1 mb-2 text-center uppercase">Skills</h2>
        <ul className="list-disc list-inside text-sm text-left">
          {(formData?.skills ?? []).map((skill, index) => (
            <li key={index}>{skill.skill || "N/A"}</li>
          ))}
        </ul>
      </div>
      ...
      {/* Awards */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold border-b pb-1 mb-2 text-center uppercase">Awards</h2>
        <ul className="list-disc list-inside text-sm text-left">
      ...
      {/* Interests */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold border-b pb-1 mb-2 text-center uppercase">Interests</h2>
        <ul className="list-disc list-inside text-sm text-left">
